...
class _FullScreenHomePageState extends State<FullScreenHomePage> {
  ...
  void _checkForLEDUpdates() {
    ...
    // This was in the original but can be left minimal for now
  }
          ...
          child: InteractiveViewer(
            ...
            child: Stack(
              children: [
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              ...
                              _buildSpecRow(
                                'Panel Size',
                                '${_selectedLED!.panelWidth}mm x ${_selectedLED!.panelHeight}mm',
                              ),
                              _buildSpecRow(
                                'Pixel Pitch',
                                '${_selectedLED!.pixelPitch}mm',
                              ),
                              _buildSpecRow(
                                'Weight',
                                '${_selectedLED!.weight}kg',
                              ),
                              _buildSectionHeader('POWER'),
                              _buildSpecRow(
                                'Max Power',
                                '${_selectedLED!.maxPower}W',
                              ),
                              _buildSpecRow(
                                'Avg Power',
                                '${_selectedLED!.avgPower}W',
                              ),
                              _buildSectionHeader('CONNECTIVITY'),
                              _buildSpecRow(
                                'Input Connectors',
                                _selectedLED!.inputConnectors,
                              ),
                              _buildSpecRow(
                                'Output Connectors',
                                _selectedLED!.outputConnectors,
                              ),
                ...
                // LED Summary Widget (bottom left)
                if (_surfaces.isNotEmpty && _surfaces.any((s) => s.isComplete))
                  Positioned(
                    bottom: 20,
                    left: 20,
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              '${led.pixelPitch}mm - ${led.panelWidth}x${led.panelHeight}mm',
                              style: TextStyle(
                                fontSize: 12,
  ...
  Future<void> _refreshCalculations() async {
    // Refresh all surface calculations
